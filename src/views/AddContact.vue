    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia reprehenderit,
                    earum
                    voluptatum molestiae quam, dolor rem ex maxime adipisci iste inventore cum, ea voluptatibus quisquam
                    nihil corporis nemo! Molestiae, numquam?</p>
            </div>
        </div>
    </div>
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-4">
                <form @submit.prevent="submitCreate()">
                    ...
                    <div class="mb-2">
                        <input required v-model="contact.photo" type="text" class="form-control"
                    ...
                    <div class="mb-2">
                        <input required v-model="contact.company" type="text" class="form-control"
                            placeholder="Company">
                    </div>
                    <div class="mb-2">
